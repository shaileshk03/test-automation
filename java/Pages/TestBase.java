...
public class TestBase {
	...
	// Load Config file Browser and URL 
	...
	public void getUrl(String url) {
	 ...
	 // Initialization of Log4j, Launch Browser and Get URL 
	public void init() throws IOException {
		loadData();
		String log4jConfPath = "E:/Selenium workspace/Amazon/src/main/resources/configfile/log4j.properties";
	...
	// Static block to initialize calendar 
	static {
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
		extent = new ExtentReports(System.getProperty("user.dir") + "/src/main/resources/reports/reports" + formater.format(calendar.getTime()) + ".html", false);
	}
	...
	// ======================>>> Result Reports with Screenshort <<<=============================
	...
	public void getScreenShot(WebDriver driver, ITestResult result, String folderName) {
		...
		File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		try {
			String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath() + "/src/main/resources/reports/reports";
